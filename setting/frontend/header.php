...
<html lang="en">
    <head>
        ...
        <title>Article Details - Parking Point</title>
    ...
    <body data-spy="scroll" data-target=".fixed-top">
        ...
        <nav class="navbar fixed-top">
            <div class="container flex flex-wrap items-center justify-between sm:px-4 lg:flex-nowrap lg:px-8">
                ...
                <a class="text-gray-800 font-semibold text-3xl leading-4 no-underline page-scroll" href="index.html">Parking Point</a>
                ...
                <div class="navbar-collapse offcanvas-collapse lg:flex lg:flex-grow lg:items-center" id="navbarsExampleDefault">
                    <ul class="pl-0 mt-3 mb-2 ml-auto flex flex-col list-none lg:mt-0 lg:mb-0 lg:flex-row">
                        ...
                        <li>
                            <a class="nav-link page-scroll" href="index.php#download">Download</a>
                        </li>
                    </ul>
