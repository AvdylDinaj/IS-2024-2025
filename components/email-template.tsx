        ...
        <Html>
            ...
            <Body style={main}>
                <Container style={container}>
                    <Heading as="h1" style={{ fontSize: '36px', lineHeight: 1.3, color: "#747474", fontWeight: 700, textAlign: "center" }}>Kosova Parking</Heading>
                    <Hr />
                    ...
                    <Section >
                        ...
                        <Row>
                            <Text style={footer.text}>
                                © 2024 Kosova Parking, Inc. All Rights Reserved.
                            </Text>
                        </Row>
                    </Section>
                </Container>
